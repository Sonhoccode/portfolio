...
export default function ProjectItems({ project }) {
  ...
  return (
    <div className="p-4 md:p-8 bg-slate-300 w-[320px] md:w-[450px] flex flex-col h-full border-2 border-black rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px]">
      ...
      <div className="flex-grow flex flex-col">
        <div className="w-full flex flex-wrap mt-4 justify-between items-end">
          <h3 className="text-xl md:text-2xl font-bold w-2/3">{project.title}</h3>
